...
public class Client {
  ...
  public void viewQuestions() {
   // Build an empty request
      ...
      try {
          ...
          // Iterate over each question and print its details
  ...
  public void searchFlights(BufferedReader reader) throws IOException {
      ...
      try {
          ...
          // Print the details of each matching flight
  ...
  /**
   * View following for user Follow
   * @param userName
   */
